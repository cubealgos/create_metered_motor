...
`create_civilization`'s `core`/`harness` boundary needs, checking the stats codec and the
tier-to-capacity/rate lookup stay free of Minecraft imports without a second module.
